...
set DIR_W3=E:\W3Modding\_game

rem *main* directory of modkit
set DIR_MODKIT=E:\W3Modding\_modTools\Witcher 3 Mod Tools

rem path to encoder binaries
set DIR_ENCODER=E:\W3Modding\_modTools\Witcher 3 Mod Tools\radish-tools
